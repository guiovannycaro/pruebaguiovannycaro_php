...
<td> <button class="btn btn-primary add" data-toggle="modal" name="add" data-target="#RegistrarDepartamentoModal	" id="Agregar">AGREGAR</button> </td>
...
<button  data-toggle="modal" data-target="#EliminarDepartamentoModal" id="<?php echo $dat['id']?>" name="drop" class="btn btn-primary btn-xs drop">Eliminar</button> 
      
      -
      
      <button  data-toggle="modal" data-target="#EditarDepartamentoModal" onclick="agregardatos('<?php echo $datos; ?>')" name="edit" class="btn btn-primary btn-xs edit">Editar</button> 
...
<div id="RegistrarDepartamentoModal" class="modal fade" role="dialog">
...
<div id="EditarDepartamentoModal" class="modal fade" role="dialog">
 <div class="modal-dialog">
 ...
 <div id="EliminarDepartamentoModal" class="modal fade" role="dialog">
 <div class="modal-dialog">
...
$(document).ready(function(){  
 ...
 datos= "nombre=" + nombre ;
			...
			$.ajax({
							type: "POST",
							method:"post",
							url: 'departamentos.php?d=captura',
							data: datos,
 ...
 datos=  "id=" + id +  "&nombre=" + nombre ;
			    $.ajax({
					      type: 'POST',
						  url: 'departamentos.php?d=capturaactualiza',
						  data: datos,
							success: function(data)
							{		
	  ...
	  $(document).on('click', '.drop', function(){
		 ...
		 var id = $(this).attr("id");
			   ...
			   $.ajax({
						type: "POST",
						method:"post",
						url: 'departamentos.php?d=eliminar',
						data: 'id='+id,
							success: function(data)
